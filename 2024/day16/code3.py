...
while to_see:
    ...
    if (row, col)==end:
        ...
        new_row=row-1
        if grid[new_row][col]['^'] > grid[row][col]['^']+1 :
            grid[new_row][col]['^'] = grid[row][col]['^']+1
            grid[new_row][col]['<'] = grid[row][col]['^']+1001
            grid[new_row][col]['>'] = grid[row][col]['^']+1001
            to_see.add((new_row,col))
        if grid[new_row][col]['^'] > grid[row][col]['>']+1001 :
...
while to_see:
    ...
    if (row, col)==start:
        ...
        if grid[new_row][col]['^'] == grid[row][col]['^']-1 :
            to_see.add((new_row,col))
        if grid[new_row][col]['v'] == grid[row][col]['h']-1001 and \
